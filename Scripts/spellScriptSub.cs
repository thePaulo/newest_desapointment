...
public class spellScriptSub : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*Vector3 alvo = targetT.position;
        alvo.y += 2;
        targetT.position = alvo;*/
    ...
    {
        Debug.Log("Toquei em " + other.gameObject.name);
        if (other.gameObject.tag == "Player")
        {
            other.gameObject.SendMessage("TakeDamage", 15);
